...
const SIZES: &[usize] = &[6, 8, 10, 12, 14, 16, 18, 20]; // 16, 18, 20]; 
...
fn main() {
  ...
  for &log_n in SIZES.iter() {
    ...
    let q_pct = (q_avg / prover_avg) * 100.0;
...
//   writeln!(file, "log_n,n,total_prover_ms,commit_q_ms,commit_g_ms,commit_h_ms,commit_batch_proof_ms,commit_q_pct,commit_g_pct,commit_h_pct,commit_batch_proof_pct")
//     .expect("Failed to write header");

//   for (log_n, n, total, q, g, h, batch, q_pct, g_pct, h_pct, batch_pct) in results {
//     writeln!(
//       file,
//       "{},{},{:.4},{:.4},{:.4},{:.4},{:.4},{:.2},{:.2},{:.2},{:.2}",
//       log_n, n, total, q, g, h, batch, q_pct, g_pct, h_pct, batch_pct
//     )
